...
public class Test : MonoBehaviour {
	...
	void Start () {
		...
		if(PlayerPrefs.GetString ("ServerAdsData").Length<=0){
			string s="<NJ_DB_FULL>0#3#ca-app-pub-3451337100490595/3106908401#200</NJ_DB_FULL><URL>https://play.google.com/store/apps/details?id=com.app.ninja#https://play.google.com/store/apps/developer?id=Quantum4U+Studios&hl=en#https://www.facebook.com/profile.php?id=100020476457047</URL><NJ_GAME>0#1#ca-app-pub-3451337100490595/7224572220#1</NJ_GAME><NJ_FAIL>0#3#ca-app-pub-3451337100490595/3106908401#1</NJ_FAIL><NJ_PAUSE>0#3#ca-app-pub-3451337100490595/3106908401#2</NJ_PAUSE><NJ_DASHBOARD>0#1#ca-app-pub-3451337100490595/7224572220#0</NJ_DASHBOAD>";
			PlayerPrefs.SetString("ServerAdsData",s) ;}

		PlayerPrefs.SetInt("FailOccurLocal",  0) ;
		PlayerPrefs.SetInt("PauseOccurLocal",  0) ;

			string url = "http://quantum4you.com/piqvalue.php?val=NINJA_GAME_IOS";
			WWW www = new WWW (url);
	...
	public static void adsCalling(int Type , String id){
		...
		if (Type == 1) {	
			googleads.RequestBanner (GoogleMobileAds.Api.AdPosition.Bottom, id);
		} else if (Type == 2) {
